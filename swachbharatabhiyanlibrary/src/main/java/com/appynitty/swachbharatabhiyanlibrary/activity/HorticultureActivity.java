...
//                onSelectFromGalleryResult(data);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == AUtils.MY_PERMISSIONS_REQUEST_CAMERA) {
            ...
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(HorticultureActivity.this, Manifest.permission.CAMERA)) {
            ...
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(HorticultureActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
...
//                Toast.makeText(getActivity(), "Unable to get Permission", Toast.LENGTH_LONG).show();
    ...
    private void initData() {
        ...
        if (Prefs.contains(AUtils.HORTI_BEFORE_IMAGE)) {
            Bitmap myBitmap = BitmapFactory.decodeFile(Prefs.getString(AUtils.HORTI_BEFORE_IMAGE, null));
            Log.e(TAG, "initData: before Image:- " + Prefs.getString(AUtils.HORTI_BEFORE_IMAGE, null));
...
//        }
    ...
    private void initToolbar() {
        toolbar.setTitle(R.string.string_horticulture_waste);
...
//changes made by swapnil for android 11 image upload
        ...
        switch (imageViewNo) {
            ...
            case 1:
                ...
                Prefs.putString(AUtils.HORTI_BEFORE_IMAGE, beforeImageFilePath);
            ...
            case 2:
                ...
                Prefs.putString(AUtils.HORTI_AFTER_IMAGE, afterImageFilePath);
