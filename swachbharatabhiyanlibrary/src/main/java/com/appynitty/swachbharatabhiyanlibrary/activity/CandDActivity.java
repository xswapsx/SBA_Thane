...
//                onSelectFromGalleryResult(data);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == AUtils.MY_PERMISSIONS_REQUEST_CAMERA) {
            ...
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(CandDActivity.this, Manifest.permission.CAMERA)) {
            ...
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(CandDActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
...
//        }
    ...
    private void initToolbar() {
        toolbar.setTitle(R.string.string_c_and_d_waste);
